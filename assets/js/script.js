...
// Pet finder
var petFinderURL = 'https://api.petfinder.com/v2/animals?type=dog&size=small';
...
// + dogSize + '&age=' + dogAge + '&gender=' + gender + '&location=' + postalCode

fetch(petFinderURL, {headers:{'Authorization': 'Bearer ' + access_token}})
.then(function (response) {
    return response.json();
})
.then(function (data) {
